...
void map_and_snake(char**&map, int** snake, int size_snake, int measure_x, int measure_y,char symbol, int comida_x, int comida_y) {
...
void menujuegito()
{
	...
	while (true)
	{
		...
		map_and_snake(cuadro1.tablero, cuerpo1.matriz_snake, cuerpo1.tamano, cuadro1.medida_vertical, cuadro1.medida_horizontal,'@',comida1.x,comida1.y);
		map_and_snake(cuadro1.tablero, cuerpo2.matriz_snake, cuerpo2.tamano, cuadro1.medida_vertical, cuadro1.medida_horizontal,'&', comida1.x, comida1.y);
		cuerpo1.move_snake();
		cuerpo2.move_snake();
		...
		//system("pause");
		cuadro1.imprime();
		//cout << cuerpo1.matriz_snake[1][0] << " " << cuerpo1.matriz_snake[1][1] << "\n";
		//cout << cuerpo2.matriz_snake[1][0] << " " << cuerpo2.matriz_snake[1][1] << "\n";
		cout << "\n" << cuerpo1.vida<<"\n";
		if (cuerpo1.vida == 0 || cuerpo1.vida == 0) {
			break;
		}
		Sleep(50);
	}
